import { IValidator, IValidationError, IValidationResult, 
            Action, Func, Func2, IRuleSetValidator, 
            IRuleSetValidatorBase, IDateRuleSetValidator, IStringRuleSetValidator, INumberRuleSetValidator } from './ivalidator';
import { TypeFactory } from './type-factory';
import { ValidationResult, ValidationError } from './validation-result';

import { StringRuleSetValidator, DateRuleSetValidator, NumberRuleSetValidator } from './ruleset-validators';
...
export class ObjectValidator<T> implements IValidator<T> {
    ...
    ForDateProperty(predicate: Func<T, Date>, ruleSet: Func<IDateRuleSetValidator<T>, IValidationResult>) : IValidator<T> {
        ...
        errorResult = ruleSet(new DateRuleSetValidator<T>(val, this._model, predicate));
    ...
    ForStringProperty(predicate: Func<T, string>, ruleSet: Func<IStringRuleSetValidator<T>, IValidationResult>) : IValidator<T> {
        ...
        errorResult = ruleSet(new StringRuleSetValidator<T>(val, this._model, predicate));
    ...
    ForNumberProperty(predicate: Func<T, Number>, ruleSet: Func<INumberRuleSetValidator<T>, IValidationResult>) : IValidator<T> {
        ...
        errorResult = ruleSet(new NumberRuleSetValidator<T>(val, this._model, predicate));
    ...
    IsCreditCard(predicate: Func<T, string>, message: string, errorIdentifier: string = null): IValidator<T> {
        var val = predicate(this._model);
    ...
    IsDateOnOrAfter(predicate: Func<T, Date>, date: Date, message: string, errorIdentifier: string = null): IValidator<T> {
        date.setHours(0,0,0,0);
        var val = predicate(this._model);
        val.setHours(0,0,0,0);
    ...
    IsDateBefore(predicate: Func<T, Date>, date: Date, message: string, errorIdentifier: string = null): IValidator<T> {
        date.setHours(0,0,0,0);
        var val = predicate(this._model);
        val.setHours(0,0,0,0);
    ...
    IsDateOnOrBefore(predicate: Func<T, Date>, date: Date, message: string, errorIdentifier: string = null): IValidator<T> {
        date.setHours(0,0,0,0);
        var val = predicate(this._model);
        val.setHours(0,0,0,0);
    ...
    IsDateBetween(predicate: Func<T, Date>, startDate: Date, endDate: Date, inclusive: boolean, message: string, errorIdentifier: string = null): IValidator<T> {
    ...
    IsDateLeapYear(predicate: Func<T, Date>, message: string, errorIdentifier: string = null): IValidator<T> {
        var val = predicate(this._model);
        val.setHours(0,0,0,0);
    ...
    IsNumberEqual(predicate: Func<T, Number>, number: Number, message: string, errorIdentifier: string = null): IValidator<T> {
        var val = predicate(this._model);
    ...
    IsNumberNotEqual(predicate: Func<T, Number>, number: Number, message: string, errorIdentifier: string = null): IValidator<T> {
        var val = predicate(this._model);
    ...
    IsNumberLessThan(predicate: Func<T, Number>, number: Number, message: string, errorIdentifier: string = null): IValidator<T> {
        var val = predicate(this._model);
    ...
    IsNumberLessThanOrEqual(predicate: Func<T, Number>, number: Number, message: string, errorIdentifier: string = null): IValidator<T> {
        var val = predicate(this._model);
    ...
    IsNumberGreaterThan(predicate: Func<T, Number>, number: Number, message: string, errorIdentifier: string = null): IValidator<T> {
        var val = predicate(this._model);
    ...
    IsNumberGreaterThanOrEqual(predicate: Func<T, Number>, number: Number, message: string, errorIdentifier: string = null): IValidator<T> {
        var val = predicate(this._model);
    ...
    private luhnAlgorithm(cc: string) : boolean {
        cc = cc.replace(' ', '');
        var sum = 0;
        var doubleUp = false;
